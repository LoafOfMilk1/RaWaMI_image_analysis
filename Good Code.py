...
# ax3.plot(row_number_vector1, np.subtract(smoother(brightness_vector4,points),smoother(brightness_vector1,points)), label='Delta 1-22/1-360')
# ax3.plot(row_number_vector1, np.subtract(smoother(brightness_vector4,points),smoother(brightness_vector2,points)), label='Delta 1-90/1-360')
# plt.xlim(420, 1450)
# plt.ylim(0,.8)
# ax3.set_xlabel('Row Number (Starting at Top of Image)')
# ax3.set_ylabel('Average Brightness Difference')
# ax3.legend()
# ax3.set_title('Average Row Pixel Brightness Difference as a Function of Height')
...
# ax4.plot(row_number_vector5, np.subtract(smoother(brightness_vector8,points),smoother(brightness_vector5,points)), label='Delta 1-22/1-360')
# ax4.plot(row_number_vector6, np.subtract(smoother(brightness_vector8,points),smoother(brightness_vector6,points)), label='Delta 1-90/1-360')
# plt.xlim(900, 2600)
# ax4.set_xlabel('Column Number (Starting at Left of Image)')
# ax4.set_ylabel('Average Brightness Difference')
# ax4.legend()
# ax4.set_title('Average Column Pixel Brightness Difference as a Function of Width')
